interface DirectionSelectorProps {
  value: 'production_to_staging' | 'staging_to_production';
  onChange: (
    direction: 'production_to_staging' | 'staging_to_production'
  ) => void;
  ...
  return (
    <div className="relative">
      <select
        ...
        onChange={(e) =>
          onChange(
            e.target.value as 'production_to_staging' | 'staging_to_production'
          )
        }
